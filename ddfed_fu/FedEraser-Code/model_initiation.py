...
# FashionMNIST 网络结构（与MNIST类似）
class Net_fashion_mnist(nn.Module):
    def __init__(self):
        super(Net_fashion_mnist, self).__init__()
...
# ImageNet 网络结构（简单ResNet18，建议根据实际需求自定义）
class Net_imagenet(nn.Module):
    def __init__(self):
        super(Net_imagenet, self).__init__()
        from torchvision.models import resnet18
        self.model = resnet18(num_classes=1000)  # ImageNet 1000类
