...
class FedQuickDropServer(FedSGAServer):
    ...
    def save_affine_dataset(self):
        ...
        for uid in self.users:
            ...
            if current_client.label_syn_train is None or current_client.image_syn_train is None:
                # Some clients may not be sampled in short runs, thus no synthetic data is produced.
                continue
